...
public class ConnectRightPtr {

    public void exeuteFn()
    {
        BinaryTree tree = new BinaryTree();
        tree.root = new NodeConnect(10);
        tree.root.left = new NodeConnect(8);
        tree.root.right = new NodeConnect(2);
//        tree.root.left.left = new NodeConnect(3);
//        tree.root.left.right = new NodeConnect(20);
//        tree.root.right.left = new NodeConnect(100);
        tree.root.right.right = new NodeConnect(90);
...
{
    int data;
    NodeConnect left, right, nextRight;

    NodeConnect(int item)
    {
        data = item;
...
class BinaryTree
{
    ...
    void connectRecur(NodeConnect p)
    {
        // Base case
        if (p == null)
            return;
    ...
    /* This function returns the leftmost child of nodes at the same
       ...
       the left child */
    NodeConnect getNextRight(NodeConnect p)
    {
        NodeConnect temp = p.nextRight;
